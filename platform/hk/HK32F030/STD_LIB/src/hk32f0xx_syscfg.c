...
/**
  ...
  * @note   This function is only used for HK32F030, HK32F031, HK32F042, HK32F072 and HK32F051 devices.   
  * @retval None
  */
...
/**
  ...
  *            @arg SYSCFG_I2CFastModePlus_I2C2: Configure fast mode plus driving capability for I2C2 pins, available only for HK32F072 devices
  *                
  * @param  NewState: new state of the DMA channel remapping. 
  *         This parameter can be:  ENABLE or DISABLE.
...
/**
  ...
  * @note   GPIOE is available only for HK32F072.
  * @note   GPIOD is not available for HK32F031.    
  * @param  EXTI_PinSourcex: specifies the EXTI line to be configured.
  * @note   This parameter can be EXTI_PinSourcex where x can be:
  *         For HK32F051 and HK32F030: (0..15) for GPIOA, GPIOB, GPIOC, (2) for GPIOD and (0..1, 4..7) for GIIOF.
  *         For HK32F072: (0..15) for GPIOA, GPIOB, GPIOC, GPIOD, GPIOE, (0..10) for GPIOF.
