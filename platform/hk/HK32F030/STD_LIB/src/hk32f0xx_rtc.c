...
/**
  ...
  *         This function is available for HK32F072 devices.  
...
/**
  ...
  *            @arg RTC_Output_WakeUp: signal of WakeUp mapped to output, available only for HK32F072 devices  
...
/**
  ...
  *            @arg RTC_IT_WUT:  WakeUp Timer interrupt mask, available only for HK32F072 devices  
...
/**
  ...
  *            @arg RTC_FLAG_WUTF: WakeUp Timer flag, available only for HK32F072 devices  
...
/**
  ...
  *            @arg RTC_IT_WUT: WakeUp Timer interrupt, available only for HK32F072 devices
