...
/* DMA2 Channelx interrupt pending bit masks: Only applicable for HK32F091 devices */
...
/**
  ...
  * @note   Channel 6 and 7 are available only for HK32F072 devices.
  * @retval None
  */
...
/**
  ...
  * @note   DMA1 Channel 6 and 7 are available only for HK32F072 and HK32F091 devices. 
  * @note   DMA2 Channel 1 to 5 are available only for HK32F091 devices.   
...
/**
  ...
  * @note   This function is available only for HK32F091 devices. 
  * @retval None
  */
