...
@verbatim
  ...
  (+) There are eight WakeUp pins: WakeUp Pin 1 on PA.00 and WakeUp Pin 2 on PC.13. 
      The following WakeUp pins are only applicable for HK32F072 dvices:
...
/**
  ...
  *             @arg PWR_WakeUpPin_1
  *             @arg PWR_WakeUpPin_2
  *             @arg PWR_WakeUpPin_3, only applicable for HK32F072 devices
  *             @arg PWR_WakeUpPin_4, only applicable for HK32F072 devices
  *             @arg PWR_WakeUpPin_5, only applicable for HK32F072 devices
  *             @arg PWR_WakeUpPin_6, only applicable for HK32F072 devices
  *             @arg PWR_WakeUpPin_7, only applicable for HK32F072 devices
  *             @arg PWR_WakeUpPin_8, only applicable for HK32F072 devices            
