...
#ifndef __HK32F0XX_DAC_H
#define __HK32F0XX_DAC_H
...
typedef struct
{
  ...
  uint32_t DAC_WaveGeneration;               /*!< Specifies whether DAC channel noise waves or triangle waves
                                                  ...
                                                  This parameter is only applicable for HK32F072 devices */
...
/** @defgroup DAC_wave_generation 
  * @brief    This parameters are only applicable for HK32F072 devices.
  * @{
  */
...
/** @defgroup DAC_lfsrunmask_triangleamplitude   
  * @brief    These parameters are only applicable for HK32F072 devices.
  * @{
  */
...
#define DAC_Channel_2                      ((uint32_t)0x00000010) /*!< Only applicable for HK32F072 devices */
...
void DAC_DualSoftwareTriggerCmd(FunctionalState NewState); /*!< Only applicable for HK32F072 devices */
void DAC_WaveGenerationCmd(uint32_t DAC_Channel, uint32_t DAC_Wave, FunctionalState NewState); /*!< Only applicable for HK32F072 devices */ 
void DAC_SetChannel1Data(uint32_t DAC_Align, uint16_t Data);
void DAC_SetChannel2Data(uint32_t DAC_Align, uint16_t Data); /*!< Only applicable for HK32F072 devices */
void DAC_SetDualChannelData(uint32_t DAC_Align, uint16_t Data2, uint16_t Data1); /*!< Only applicable for HK32F072 devices */
