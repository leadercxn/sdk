...
#define USART_WordLength_7b                  ((uint32_t)0x10001000) /*!< only available for HK32F072 and HK32F030 devices */
...
/** @defgroup USART_StopMode_WakeUp_methods
  * @note     These parameters are only available for HK32F051 and HK32F072 devices 
  * @{
  */ 
