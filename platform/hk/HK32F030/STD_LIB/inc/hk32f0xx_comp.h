/**
  ******************************************************************************
  * @file    hk32f0xx_comp.h 
  ****************************************************************************** 
  */

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HK32F0XX_COMP_H
#define __HK32F0XX_COMP_H
...
#define COMP_InvertingInput_DAC2                ((uint32_t)0x00000050) /*!< DAC2_OUT (PA5) connected to comparator inverting input, applicable only for HK32F072 devices */
